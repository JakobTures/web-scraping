...
We can also see that the mean we calculated in chapter \@ref(dplyr) -- 11:57 --
is misleading. As a relevant number of reports are filed in the time span of late
afternoon to early evening, the mean is biased to the right. 11:57 is not the
peak of the distribution; actually, half of all reports are filed before 11:05, as
