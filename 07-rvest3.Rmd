...
package **lubridate**, which has recently been promoted to be a part of the core
tidyverse,  makes it easy to convert dates from character or numeric vectors 
into the "Date" format. Among other things, it offers a number of
