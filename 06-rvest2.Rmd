...
`"table.wikitable:nth-child(47)"`. We thus select the table of class 
`"wikitable"` which is the 47nd child of the parent hierarchy level -- 
...
``` {r select_css_table}
elements <- website %>% 
  html_elements(css = "table.wikitable:nth-child(47)")
elements

element <- website %>% 
  html_element(css = "table.wikitable:nth-child(47)")
element
```
